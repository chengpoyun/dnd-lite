...
-- 生命值和臨時數據表
CREATE TABLE character_current_stats (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  character_id UUID REFERENCES characters(id) ON DELETE CASCADE,
...
CREATE INDEX idx_character_ability_scores_character_id ON character_ability_scores(character_id);
CREATE INDEX idx_character_saving_throws_character_id ON character_saving_throws(character_id);
CREATE INDEX idx_character_skill_proficiencies_character_id ON character_skill_proficiencies(character_id);
CREATE INDEX idx_character_current_stats_character_id ON character_current_stats(character_id);
...
CREATE INDEX idx_character_combat_actions_character_id ON character_combat_actions(character_id);
CREATE INDEX idx_character_combat_actions_category ON character_combat_actions(category);
