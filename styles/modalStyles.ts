...
// ===== 按鈕樣式 =====
export const BUTTON_PRIMARY_CLASS = "flex-1 px-6 py-3 bg-amber-600 hover:bg-amber-700 rounded-lg font-medium text-slate-900 transition-colors disabled:opacity-50";
