...
- 五個組織：獵人公會（4 階，1/10/25/50）、皇家古生物學院（8 階，1/3/10/25/50/80/100/120）、塔龍協會（3 階，1/10/25）、威卡德米學院（5 階，1/3/10/25/50）、螺旋委員會（7 階，1/3/10/25/50/80/100）。倍數為 `2^(階級-1)`，唯獨**塔龍協會是 `2^階級`**（同階級強一倍，刻意設計）；**階級 0 一律 ×1**（否則公式會算出 0.5）。加入多個組織時取倍數最高者。
